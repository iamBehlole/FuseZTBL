...
import {
    ...
    MasterCodes, RecoveryCustomer, RecoveryDataModel,
...
export class JvFormComponent implements OnInit, OnDestroy {
    ...
    openJVMasterCodeDialog() {
        ...
        const dialogRef = this.dialog.open(JvMasterCodeDialogComponent, {
            width: '1400px',
    ...
    openJvOrganizationDialog() {
        const dialogRef = this.dialog.open(JvOrganizationalStructureComponent, {
            width: '800px',
