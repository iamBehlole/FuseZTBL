...
export class LovService {
    ...
    public async CallLovAPI(DataObj: Lov) {
        ...
        const req = JSON.stringify({LovPagination: {TagName: DataObj.TagName}});
    ...
    public async CallChildLovAPI(DataObj: ChildLov) {
        ...
        const req = JSON.stringify({LovPagination: {TagName: DataObj.TagName, ParentId: DataObj.ParentId}});
