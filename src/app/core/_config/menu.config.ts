	...
	public defaults: any = {
		...
		aside: {
			...
			items: [
              ...
              page: '/configuration-management/document-types'
            },
            {
              title: 'Configurations',
              page: '/configuration-management/configurations'
            }
					]
				},
				{
					...
					submenu: [
						{
              title: 'Api-logs',
              page: '/report-management/api-logs'
            },
            {
              title: 'Exception-logs',
              page:'/report-management/exception-logs'
            },
            {
              title: 'Notification-history',
              page: '/report-management/notification-history'
            },
            {
              title: 'User-history',
              page: '/report-management/user-history'
            }
					]
				},
				{
            ...
            {
              title: 'ViewCirclesfence',
              page: '/user-management/viewCirclesfence'
            },
					]
				},
				{ section: 'Custom' },
